...
You could also build your own H5 and JSON files. Each instance in H5 file is a complete 3D image after the same preprocessing from [nnUNet](https://github.com/MIC-DKFZ/nnUNet) and is resized to 128x128x128.
